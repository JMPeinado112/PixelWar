...
public class Eleccion extends JPanel implements ActionListener {
	...
	String fotos[] = { null, "Stickman", "Mario", "Link", "Pikachu", "Donkey Kong", "Sonic", "Creeper", "Goku",
	...
	public Eleccion(int num) {
		...
		fondo.setIcon(new ImageIcon(
				new ImageIcon("assets/fondos/").getImage().getScaledInstance(1100, 700, Image.SCALE_DEFAULT)));
		add(fondo);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cantidades == 3) {
			if (e.getSource() == start) {
				...
				if (s1 == null || s2 == null || s3 == null) {
					...
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO", "Error de nombre de equipo",
							0);
				} else if (textField_1.getText().equals(textField_2.getText())
						|| textField_1.getText().equals(textField_3.getText())
						|| textField_2.getText().equals(textField_3.getText())) {
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO DIFERENTE",
							"Error de nombre de equipo", 0);
				} else {
			...
			if (e.getSource() == start) {
				...
				if (cantidades == 4 && s1 == null || s2 == null || s3 == null || s4 == null) {
					...
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO", "Error de nombre de equipo",
						...
						|| textField_1.getText().equals(textField_3.getText())
						|| textField_2.getText().equals(textField_3.getText())
						|| textField_1.getText().equals(textField_4.getText())
						|| textField_2.getText().equals(textField_4.getText())
						|| textField_3.getText().equals(textField_4.getText())) {
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO DIFERENTE",
							"Error de nombre de equipo", 0);
				} else {
			...
			if (e.getSource() == start) {
				...
				if (cantidades == 4 && s1 == null || s2 == null || s3 == null || s4 == null || s5 == null) {
					...
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO", "Error de nombre de equipo",
						...
						|| textField_2.getText().equals(textField_4.getText())
						|| textField_3.getText().equals(textField_4.getText())
						|| textField_1.getText().equals(textField_5.getText())
						|| textField_2.getText().equals(textField_5.getText())
						|| textField_3.getText().equals(textField_5.getText())
						|| textField_4.getText().equals(textField_5.getText())) {
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO DIFERENTE",
							"Error de nombre de equipo", 0);
				} else {
		...
		if (cantidades == 6) {
			if (e.getSource() == start) {
				...
				if (cantidades == 6 && s1 == null || s2 == null || s3 == null || s4 == null || s5 == null
						|| s6 == null) {
					...
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO", "Error de nombre de equipo",
						...
						|| textField_3.getText().equals(textField_5.getText())
						|| textField_4.getText().equals(textField_5.getText())
						|| textField_1.getText().equals(textField_6.getText())
						|| textField_2.getText().equals(textField_6.getText())
						|| textField_3.getText().equals(textField_6.getText())
						|| textField_4.getText().equals(textField_6.getText())
						|| textField_5.getText().equals(textField_6.getText())) {
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO DIFERENTE",
							"Error de nombre de equipo", 0);
				} else {
			...
			if (e.getSource() == start) {
				...
				if (cantidades == 6 && s1 == null || s2 == null || s3 == null || s4 == null || s5 == null || s6 == null
					...
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO", "Error de nombre de equipo",
						...
						|| textField_4.getText().equals(textField_6.getText())
						|| textField_5.getText().equals(textField_6.getText())
						|| textField_1.getText().equals(textField_7.getText())
			...
			if (e.getSource() == start) {
				...
				if (cantidades == 6 && s1 == null || s2 == null || s3 == null || s4 == null || s5 == null || s6 == null
					...
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO", "Error de nombre de equipo",
						...
						|| textField_5.getText().equals(textField_7.getText())
						|| textField_6.getText().equals(textField_7.getText())
						|| textField_1.getText().equals(textField_8.getText())
						|| textField_2.getText().equals(textField_8.getText())
						|| textField_3.getText().equals(textField_8.getText())
						|| textField_4.getText().equals(textField_8.getText())
						|| textField_5.getText().equals(textField_8.getText())
						|| textField_6.getText().equals(textField_8.getText())
						|| textField_7.getText().equals(textField_8.getText())) {
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO DIFERENTE",
							"Error de nombre de equipo", 0);
				} else {
			...
			if (e.getSource() == start) {
				...
				if (cantidades == 6 && s1 == null || s2 == null || s3 == null || s4 == null || s5 == null || s6 == null
					...
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO", "Error de nombre de equipo",
						...
						|| textField_6.getText().equals(textField_8.getText())
						|| textField_7.getText().equals(textField_8.getText())
						|| textField_1.getText().equals(textField_9.getText())
						|| textField_2.getText().equals(textField_9.getText())
						|| textField_3.getText().equals(textField_9.getText())
						|| textField_4.getText().equals(textField_9.getText())
						|| textField_5.getText().equals(textField_9.getText())
						|| textField_6.getText().equals(textField_9.getText())
						|| textField_7.getText().equals(textField_9.getText())
						|| textField_8.getText().equals(textField_9.getText())) {
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO DIFERENTE",
							"Error de nombre de equipo", 0);
				} else {
			...
			if (e.getSource() == start) {
				...
				if (cantidades == 6 && s1 == null || s2 == null || s3 == null || s4 == null || s5 == null || s6 == null
					...
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO", "Error de nombre de equipo",
						...
						|| textField_7.getText().equals(textField_9.getText())
						|| textField_8.getText().equals(textField_9.getText())
						|| textField_1.getText().equals(textField_10.getText())
						|| textField_2.getText().equals(textField_10.getText())
						|| textField_3.getText().equals(textField_10.getText())
						|| textField_4.getText().equals(textField_10.getText())
						|| textField_5.getText().equals(textField_10.getText())
						|| textField_6.getText().equals(textField_10.getText())
						|| textField_7.getText().equals(textField_10.getText())
						|| textField_8.getText().equals(textField_10.getText())
						|| textField_9.getText().equals(textField_10.getText())) {
					JOptionPane.showInternalMessageDialog(null, "ELIGE NOMBRE DE EQUIPO DIFERENTE",
							"Error de nombre de equipo", 0);
				} else {
