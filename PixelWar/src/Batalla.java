		...
		if (cantidad == 3) {
			...
			atack.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(num4 > nmisiles) {
						JOptionPane.showInternalMessageDialog(null, "EL MAXIMO DE MISILES ES DE " +nmisiles, "Error de misiles", 0);
					}
					...
					if(num4 < nmisiles+1 && num4 >0 && num3 == 0 && cont == 0) {
						...
						if(equipo ==0 ) {
							...
							resumen.add(nom[0]+" a atacado con "+ equipoma+" a "+ equipoObj +" y se ha defendido con "+equipomd+"\n");
						...
						if(equipo==1) {
							...
							int equipomd = mD;
							String equipoObj = equipoa;
							resumen.add(nom[1]+" a atacado con "+ equipoma+" a "+ equipoObj +" y se ha defendido con "+equipomd+"\n");
						}
						if(equipo==2) {
							...
							int equipomd = mD;
							String equipoObj = equipoa;
							resumen.add(nom[2]+" a atacado con "+ equipoma+" a "+ equipoObj +" y se ha defendido con "+equipomd+"\n");
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(num4 < 51 && num4 >0 && num3 == 0 && cont == 0) {
						...
						if(equipo ==0 ) {
							...
							resumen.add(nom[0]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
						...
						if(equipo==1) {
							...
							int equipomd = mD;
							String equipo1Obj = equipoa;
							resumen.add(nom[1]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
						}
						if(equipo==2) {
							...
							int equipomd = mD;
							String equipo1Obj = equipoa;
							resumen.add(nom[2]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
						}
						if(equipo==3) {
							JOptionPane.showInternalMessageDialog(null, "Adios", "Error de misiles", 0);
							equipoa=s1;
							...
							int equipomd = mD;
							String equipo1Obj = equipoa;
							resumen.add(nom[3]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
							finalizar(cantidad,tipos,nom);
						}
						equipo=equipo+1;
						if(equipo < cantidad) {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(num4 < 51 && num4 >0 && num3 == 0 && cont == 0) {
						...
						if(equipo==4) {
							...
							int equipomd = mD;
							String equipo1Obj = equipoa;
							resumen.add(nom[4]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
							finalizar(cantidad,tipos,nom);
						}
						equipo=equipo+1;
						if(equipo < cantidad) {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(num4 < 51 && num4 >0 && num3 == 0 && cont == 0) {
						...
						if(equipo==5) {
							...
							int equipomd = mD;
							String equipo1Obj = equipoa;
							resumen.add(nom[5]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
							finalizar(cantidad,tipos,nom);
						}
						equipo=equipo+1;
						if(equipo < cantidad) {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(num4 < 51 && num4 >0 && num3 == 0 && cont == 0) {
						...
						if(equipo==6) {
							...
							int equipomd = mD;
							String equipo1Obj = equipoa;
							resumen.add(nom[6]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
							finalizar(cantidad,tipos,nom);
						}
						equipo=equipo+1;
						if(equipo < cantidad) {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(num4 < 51 && num4 >0 && num3 == 0 && cont == 0) {
						...
						if(equipo==7) {
							...
							int equipomd = mD;
							String equipo1Obj = equipoa;
							resumen.add(nom[7]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
							finalizar(cantidad,tipos,nom);
						}
						equipo=equipo+1;
						if(equipo < cantidad) {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(num4 < 51 && num4 >0 && num3 == 0 && cont == 0) {
						...
						if(equipo==8) {
							...
							int equipomd = mD;
							String equipo1Obj = equipoa;
							resumen.add(nom[8]+" a atacado con "+ equipoma+" a "+ equipo1Obj +" y se ha defendido con "+equipomd+"\n");
							finalizar(cantidad,tipos,nom);
						}
						equipo=equipo+1;
						if(equipo < cantidad) {
